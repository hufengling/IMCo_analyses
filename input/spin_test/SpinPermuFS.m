function SpinPermuFS(readleft, readright, permno, filedir, wsname)
...
% readleft     - the filename of left surface data to spin (without extension)
% readright    - the filename of right surface data to spin (without extension)
% permno       - the number of permutations
% filedir      - directory of files to be spun
