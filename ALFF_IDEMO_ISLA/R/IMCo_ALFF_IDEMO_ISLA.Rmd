...
#RUNOTHER here("R/batch_scripts/01_commands.sh") on login node
...
```{r}
#RUNOTHER here("R/batch_scripts/02_calculate_pvals.R) on interactive server
...
ggsave(plot = modality_yeo7_barplot, file.path(settings$output_dir, "figures", "yeo7_pval-prop_fdr05.png"), type = "cairo-png")
...
ggsave(plot = modality_aal_barplot, file.path(settings$output_dir, "figures", "aal_pval-prop_fdr05.png"), type = "cairo-png")
```
