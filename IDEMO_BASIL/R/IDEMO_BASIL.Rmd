...
input_filepaths <- common_pts %>% 
  mutate(modality_1 = paste0(subj_num, "_sigchange_cope1_TaskStd.nii.gz") %>% file.path("~/Documents/IMCo_analyses/input/niftis/idemo", .),
         modality_2 = paste0(subj_num, "_pvgmpnc_cbf.nii.gz") %>% file.path("~/Documents/IMCo_analyses/input/niftis/cbf-basil-origin", .))
...
modalities <- c("idemo", "cbf-basil-origin") #TOCHANGE
fwhm <- 3
prop_miss <- 0.9
