...
alff_plot <- ggplot(voxel_vals_df, aes(age, V1)) + 
  geom_point(colour = "grey69") + 
  geom_smooth(method = 'lm', formula = y ~ x, se = F, colour = "grey22", size = 3) +
  labs(x = "Age", y = "ALFF") +
  scale_x_continuous(limits = x_lim) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1.1 * max(voxel_vals_df$V1))) + 
...
cbf_plot <- ggplot(voxel_vals_df, aes(age, V2)) + 
  ...
  labs(x = "Age", y = "CBF") +
  scale_x_continuous(limits = x_lim) +
  scale_y_continuous(expand = c(0, 0), limits = c(1.3 * min(voxel_vals_df$V2), 1.1 * max(voxel_vals_df$V2))) + 
  theme(panel.border = element_blank(), 
        panel.background = element_blank(),
        panel.grid.major.y = element_line(color = "gray85"),
        axis.line = element_line(colour = "black"),
...
reho_plot <- ggplot(voxel_vals_df, aes(age, V3)) + 
  ...
  labs(x = "Age", y = "ReHo") +
  scale_x_continuous(limits = x_lim) +
  scale_y_continuous(expand = c(0, 0), limits = c(0, 1.1 * max(voxel_vals_df$V3))) + 
  theme(panel.border = element_blank(), 
        panel.background = element_blank(),
        panel.grid.major.y = element_line(color = "gray85"),
        axis.line = element_line(colour = "black"),
...
coupling_hist <- ggplot(voxel_vals_df, aes(V4)) +
  geom_histogram(fill = "grey69", colour = "grey40", bins = 15) +
  labs(x = "Coupling") +
  theme(panel.border = element_blank(), 
        panel.background = element_blank(),
        panel.grid.major.y = element_line(color = "gray85"),
...
ggplot(alff_cbf_df) + 
  geom_point(aes(cbf, alff, size = weights), colour = "grey69") + 
...
wlrpca <- ggplot(alff_cbf_df) + 
  geom_ellipse(aes(x0 = eigen_center_x, y0 = eigen_center_y, 
                   ...
                   b = 5 * sqrt(eigen_val$values[2]), 
                   angle = atan(eigen_major)),
               size = line_size, color = "grey22") +
  geom_abline(intercept = eigen_center_y - eigen_major * eigen_center_x, slope = eigen_major, size = line_size, color = "grey22") + # major axis of PCA ellipse
  geom_abline(intercept = eigen_center_y - eigen_minor * eigen_center_x, slope = eigen_minor, size = line_size, color = "grey22") + # minor axis of PCA ellipse
  ...
  geom_point(aes(alff, cbf, size = weights), colour = "grey69", show.legend = F) + 
  # annotate(geom = "text", 
